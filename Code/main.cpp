...
void draw_credit_text()
{
	...
	strcpy(string[3],"Delhi Technological University");
	strcpy(string[2],"Thank you!");
	strcpy(string[1],"Shubham Kumar (2K18MC111)");
	strcpy(string[0],"Akanksha Dhyani (2K18MC009)");
	strcpy(string[4],"");
...
void RenderScene()
{
	...
	if(page==1)
	{
		...
		if(!full)
		{
			drawString(-129.0,65.0,0.0,"Delhi Technological University");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-90.0,55.0,0.0,"Made By:");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-110.0,45.0,0.0,"Shubham Kumar-2K18MC111");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-105.0,35.0,0.0,"Akanksha Dhyani-2K18MC009");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
		...
		{
			drawString(-105.0,65.0,0.0,"Delhi Technological University");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-80.0,55.0,0.0,"Made By:");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-95.0,45.0,0.0,"Shubham Kumar-2K18MC111");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-92.0,35.0,0.0,"Akanksha Dhyani-2K18MC009");
			setFont(GLUT_BITMAP_TIMES_ROMAN_24);
			glColor3f(0.0,0.0,0.0);
